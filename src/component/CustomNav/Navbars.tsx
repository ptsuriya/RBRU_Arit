	...
	return (
		<>
			...
			<Navbar className={`header ${!atTop && "sticky"}  p-0`}>
				<div className="header-inner  navbar-expand-lg navbar">
					<Container>
						<Link className="navbar-brand" href="/" ><img className="w-100 pt-1" src="/image/logo.png" alt="" /> </Link>
